...
* 日志示例
  ...
  ```bash
  2022-07-11 10:26:59.499204,undefined,,ob9988.zhixin.lm.100.88.147.179:sys:test,OB_MYSQL,SELECT,success,,1,1,0,0,41480us,332us,40369us

  # 日志分析
  1,2022-07-11 10:26:59.499204   #日志打印时间
  2,undefined      # 逻辑租户名
  3,               # 逻辑库名
  4,ob9988.zhixin.lm.100.88.147.179:sys:test  # 物理库信息（cluster:tenant:database）
  5,OB_MYSQL  # 数据库类型
  6,SELECT    # SQL 类型
...
* 日志示例
  ...
  ```bash
  2022-07-11 14:32:51.758270,undefined,,,,cluster:sys:test,OB_MYSQL,,,COM_QUERY,SELECT,success,,select sleep(3),3041116us,409us,0us,3039883us,Y0-7F4B1CEA13A0,,,,0,11.xxx.xxx.53:33041
  ```
