...
* 使用 RPM 安装部署 ODP 请参考 [通过命令行部署 ODP](230.install-odp.md)。
...
OBD 默认会安装最新版本，若想要安装指定 ODP 版本需要在配置文件中指定，配置文件中 ODP 的配置可参考下面内容，具体配置项的介绍请参考 [配置参数说明](../200.install/200.parameter-description.md)。
