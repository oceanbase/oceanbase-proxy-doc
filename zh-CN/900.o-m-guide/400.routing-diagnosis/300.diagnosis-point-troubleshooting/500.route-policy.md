...
| proxy_primary_zone | 表示 ODP 指定的 Primary Zone  | 值应对应 ODP 配置项 [proxy_primary_zone_name](../../../400.configuration-management/300.multi-level-configuration-items/1840.proxy-primary-zone-name.md)。  |
