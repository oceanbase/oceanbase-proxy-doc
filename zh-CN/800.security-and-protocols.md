...
* compression_algorithm：用于控制压缩协议和 OceanBase 2.0 协议的压缩级别。详细介绍可参见 [compression_algorithm](400.configuration-management/200.dynamically-effective/217.compression-algorithm.md)。
