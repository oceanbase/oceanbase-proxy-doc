...
* enable_ob_protocol_v2：判断是否使用 OceanBase 2.0 协议，详细介绍可参见 [enable_ob_protocol_v2](400.configuration-management/200.global-configuration-items/660.enable-ob-protocol-v2.md)。

* enable_compression_protocol：判断是否使用压缩协议，详细介绍可参见 [enable_compression_protocol](400.configuration-management/200.global-configuration-items/490.enable-compression-protocol.md)。

* compression_algorithm：用于控制压缩协议和 OceanBase 2.0 协议的压缩级别。详细介绍可参见 [compression_algorithm](400.configuration-management/300.multi-level-configuration-items/217.compression-algorithm.md)。
