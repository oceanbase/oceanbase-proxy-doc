...
| [proxy_cluster](200.dynamically-effective/1777.proxy_cluster.md) | 用于设置 ODP 集群名称，标记该 ODP 所属的 ODP 集群。 |
...
| [scan_buffered_rows_warning_threshold](200.dynamically-effective/2056.scan_buffered_rows_warning_threshold.md) | 用于设置分片表扫描请求获取的行数阈值，超过阈值时将在 ODP 日志中打印警告信息。 |
