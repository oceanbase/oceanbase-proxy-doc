...
| [init_sql](200.dynamically-effective/1340.init_sql.md)  | 用于设置 ODP 在连接 OceanBase 集群成功后发送给 OceanBase 集群的初始化 SQL。  |
...
| 配置项  | 功能描述    | 备注    |
|--------|-------------|--------|
| [enable_binlog_service](200.dynamically-effective/410.enable-binlog-service.md) | 用于控制 ODP 是否向 oblogproxy 发送 binlog 请求。 | 自 4.2.2 版本起弃用。 |
| [enable_connection_diagnosis](200.dynamically-effective/510.enable_connection_diagnosis.md) | 用于控制是否开启连接诊断功能。  | 自 4.2.2 版本起弃用。 |
