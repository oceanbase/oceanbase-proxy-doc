...
| PROXYROUTE QUERYASYNC  | 展示 ODP 中异步查询的相关信息。缓存信息的存在时间可通过修改 [partition_location_expire_relative_time](../../../400.configuration-management/200.global-configuration-items/1720.partition-location-expire-rela.md) 配置项控制。  |
