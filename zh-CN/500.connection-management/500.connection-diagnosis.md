...
2. 根据抓包信息判断断连接问题
   ...
   输出如下，抓取客户端到 ODP 或者 ODP 到 OceanBase 数据库的包，发现 OceanBase 数据库到 ODP 之间 16:56:45.766101 至 16:57:46.161016 间隔了 60s 没有传输数据，可以确定 ODP 因为 net_write_timeout 超时而产生断连接。
