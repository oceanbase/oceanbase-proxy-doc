...
此处仅为示例，您可将 `proxy_id` 配置为 0~8191 范围中除 2 以外的任意值，不与其他 ODP 重复即可。`proxy_id` 和 `client_session_id_version` 配置项的详细介绍可参见 [proxy_id](../400.configuration-management/200.dynamically-effective/1795.proxy-id.md) 和 [client_session_id_version](../400.configuration-management/200.dynamically-effective/135.client-session-id-version.md)。
