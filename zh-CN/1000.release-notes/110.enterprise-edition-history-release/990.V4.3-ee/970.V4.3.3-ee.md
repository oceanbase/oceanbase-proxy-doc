...
* RPM 版本号：obproxy-4.3.3.0-202025012014

### 发版目的

ODP 支持 LSOP 请求的 batch get 操作类型。

### 缺陷修复

* 修复指定 Primary Zone 为单 Zone 时，读写分离地址失效的问题。

* 修复 obtrade 执行 SQL 报错 `fetch out of sequence` 的问题。
...
* RPM 版本号：obproxy-4.3.3.0-152024123010
