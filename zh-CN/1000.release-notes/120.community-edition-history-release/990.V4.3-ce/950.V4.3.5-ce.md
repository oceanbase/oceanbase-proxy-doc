...
* RPM 版本号：obproxy-ce-4.3.5.0-3

### 版本定位

ODP 4.3.5 版本是 ODP 4.3.x 的最新版本，推荐线下业务用于 POC 测试、生产。新增支持 String 类型路由、分区键的列等值关系推导、multi-stmt 事务路由、month 函数路由等功能，增强核心路由能力；支持会话连接池，提升短连接场景的路由性能；主动感知并处理 MetaDB 中删除的配置，提升配置项的稳定性；细化最大连接数超限时的错误日志，提升诊断易用性。RPC 代理，优化单分区表的判断逻辑，增强 OBKV 场景的路由准确性，新增多个 show 命令展示对象信息，完善监控能力，提升运维易用性。
