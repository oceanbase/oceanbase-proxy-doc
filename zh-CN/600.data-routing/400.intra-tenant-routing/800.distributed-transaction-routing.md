...
<main id="notice" type='notice'>
   ...
   <li>
   <p>开启分布式事务路由后，<code>ob_trx_idle_timeout</code> 的配置将失效。<code>ob_trx_idle_timeout</code> 的详细介绍可参见 <a href='https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000642443'>ob_trx_idle_timeout</a></p>
   </li>
   </ul>
</main>
