...
复制表是 OceanBase 数据库中的一种特殊表结构，支持在任意一个副本读取数据的最新修改，适合于对写入频率要求较低，读延时和读负载均衡要求较高的场景。复制表的详细信息可参见 OceanBase 数据库文档 [创建表](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001052220) 一文。
