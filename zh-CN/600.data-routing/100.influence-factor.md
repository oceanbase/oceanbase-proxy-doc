...
* 方法二：在执行 EXECUTE 前，将 PREPARE 的状态同步给 OBServer2 节点，参考 [连接管理](../500.connection-management.md) 一文中的状态同步；该方法需要 ODP 同步连接状态，实现复杂，但可以利用分布式系统的优势，目前 ODP 正是采用该方法。
