...
For more information about the fields in connection logs and how to diagnose connection issues based on logs, see [Connection diagnostics](../500.connection-management/500.connection-diagnosis.md).
