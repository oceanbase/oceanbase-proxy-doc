...
| proxy_primary_zone | The primary zone specified in ODP. | The value is the same as that of the ODP parameter [proxy_primary_zone_name](../../../400.configuration-management/300.multi-level-configuration-items/1840.proxy-primary-zone-name.md).  |
