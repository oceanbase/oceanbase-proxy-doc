...
* Deploy ODP by using a CLI. For more information, see [Deploy ODP by using a CLI](230.install-odp.md).

## Prerequisites

* You have deployed OCP. For detailed instructions, see [OCP Deployment Guide](https://en.oceanbase.com/docs/community-ocp-en-10000000000840029).
