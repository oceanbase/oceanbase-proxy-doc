...
<main id="notice" type='explain'>
  <h4>Note</h4>
  <p>We recommend that you install ODP as a non-root user. This example describes how to install ODP as the admin user.</p>
</main>

1. Run the following commands to grant or revoke the write privilege on the `sudoers` file:
