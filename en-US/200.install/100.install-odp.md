...
You can also install and deploy ODP by using OceanBase Cloud Platform (OCP). For more information, see [Create an OBProxy cluster](https://en.oceanbase.com/docs/enterprise-oceanbase-ocp-en-10000000000838390).
...
When you connect to OceanBase Database through ODP, you must combine the cluster name, instance name, and username. Valid format: `Username@Tenant name#Cluster name` or `Cluster name:Tenant name:Username`.
