...
| [tunnel_request_size_threshold](../../../400.configuration-management/200.global-configuration-items/2530.tunnel-request-size-threshold.md)  | Deprecated  | This parameter is deprecated starting from ODP 4.3.4. Its functionality is replaced by `request_buffer_length`. |
