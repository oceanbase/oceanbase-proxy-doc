...
* Fixed the issue that connection through ODP is interrupted when all parameters related to the prepared statement (PS) protocol of the MySQL driver of a higher version are set to `null`.
