...
|enable_standby                      |Modified   |This parameter specifies whether to enable routing to the primary and standby tenants in ODP V4.3.1 and later.                                                                      |
|proxy_primary_zone_name           |Modified   |This parameter supports multiple zone names in ODP V4.3.1 and later.                                                                                                                |
|binlog_service_ip                  |Modified   |This parameter supports multiple IP addresses or domain names in ODP V4.3.1 and later.                                                                                              |
...
| proxy_mem_limited                 | Modified     | The value range of this parameter has been changed from <code>[100MB, 100G]</code> to <code>[100MB, +∞)</code> since ODP V4.3.1. |
...
* Fixed the issue where the execution of the `BEGIN` statement by the JDBC driver hangs when both the PreparedStatement and PrepareExecute protocols are enabled for ODP to connect to an OceanBase cluster.
