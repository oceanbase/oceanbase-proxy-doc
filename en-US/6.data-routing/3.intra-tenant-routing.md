...
OceanBase Database supports up to hundreds of thousands and even millions of partitions. The number of ODPs is subject to the deployment architecture. When ODP is deployed on the application side, a large number of ODPs exist. Therefore, data freshness of cached information is a big challenge for ODP. If expired cached information is used, the route is inaccurate. The following describes how ODP ensures data freshness of cached information.
