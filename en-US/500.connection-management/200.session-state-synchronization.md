...
|slug|session-status-synchronization|
...
![Session](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odp/V4.2.1/zh-CN/500.connection-management/3.png)
...
![Example](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odp/V4.2.1/zh-CN/500.connection-management/4.png)
...
4. In Session0, the system variable `autocommit` is set to `0`, while in Session2, the system variable remains at its default value of `1`. In this case, ODP will override the value of `AUTOCOMMIT=0` from Session0 to Session2 to ensure that the client's session status remains consistent with the server's session status.
   ...
   ![Synchronization](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/odp/V4.2.1/en-US/500.connection-management/200.session-state-synchronization-5.png)
