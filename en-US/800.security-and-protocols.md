...
* `server_protocol`: specifies the type of the protocol used between OceanBase Database Proxy (ODP) and OceanBase Database. For more information, see the [server_protocol](400.configuration-management/200.global-configuration-items/2119.server-protocol.md).
...
Both the compression protocol and the OB 2.0 protocol verify data to ensure data correctness.
