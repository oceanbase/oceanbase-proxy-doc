...
* `enable_ob_protocol_v2`: specifies whether to use the OceanBase 2.0 protocol. For more information, see the [enable_ob_protocol_v2](400.configuration-management/200.global-configuration-items/660.enable-ob-protocol-v2.md).

* `enable_compression_protocol`: specifies whether to use the compression protocol. For more information, see the [enable_compression_protocol](400.configuration-management/200.global-configuration-items/490.enable-compression-protocol.md).

* `compression_algorithm`: specifies the compression protocol and compression level of the OceanBase 2.0 protocol. For more information, see the [compression_algorithm](400.configuration-management/300.multi-level-configuration-items/217.compression-algorithm.md).
